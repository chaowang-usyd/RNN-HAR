function [llh,hd_end,hw_end,hm_end,VaR_end,QS_End] = RNN_HaR_llh(y,rv_all,theta_particles,alpha_level,act_fun)
...
for t = 2:T
    Var_t(t) = beta0 + beta1*h_d(t-1) + beta2*h_w(t-1) + beta3*h_m(t-1);
    QS_t(t)=((y(t)<Var_t(t))-alpha_level)*(Var_t(t)-y(t));
